  ...
  return (
    <header className="absolute w-full z-50 transition-all duration-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
        ...
        >
          <div
            className="h-10 w-10 rounded-xl bg-gradient-to-r from-gray-500 to-gray-100 flex 
            items-center justify-center text-purple-700 font-bold text-xl mr-3"
          >
            T
          </div>

          <span
            className="text-xl font-bold bg-gradient-to-r from-gray-400 
          ...
          {["Home", "About", "Projects", "Experience", "Contact"].map(
            (item, index) => (
              <motion.a
                ...
                className="relative text-gray-800 dark:text-gray-200 hover:text-violet-600 
                dark:hover:text-violet-400 font-medium transition-colors duration-300 group"
                href="#"
              >
                {item}
                <span
                  className="absolute bottom-0 left-0 w-0 h-0.5 bg-violet-700 
      ...
      >
        ...
        >
          <div className="flex space-x-5">
            <a href="#">
              <FiGithub className="w-6 h-6 text-gray-400" />
            </a>

            <a href="#">
              <FiTwitter className="w-6 h-6 text-gray-400" />
            </a>

            <a href="#">
              <FiLinkedin className="w-6 h-6 text-gray-400" />
            </a>
          </div>
          <button
            onClick={() => {
            ...
            className="mt-4 block w-full px-4 py-2 rounded-xl 
            bg-gradient-to-r from-violet-600 to-violet-500 font-bold"
          >
            Contact Me
          </button>
        </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={closeContactForm}>
                  <FiX className="w-5 h-5 text-gray-400 font-extrabold" />
                </button>
              </div>
              ...
              <form className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full px-4 py-2 bg-gradient-to-r from-violet-700 
                to-violet-500 hover:from-violet-700 
                hover:to-purple-700 transition-all duration-300 rounded-lg 
